...
public class ARPlacement : MonoBehaviour
{
    ...
    //private List<GameObject> placedObjects; //this will contain any objects we create
    ...
    void Update()
    {
        ...
        if (aRRaycastManager.Raycast(touchPosition, hits, UnityEngine.XR.ARSubsystems.TrackableType.PlaneWithinPolygon))
        {
            ...
            //instantiate everytime you touch a position on the plane, the object
            ...
            else
            {
                ...
                {
                    placedObj = Instantiate(gameObjectToCreate, hitPose.position, hitPose.rotation);
                    Debug.Log("debug create an object " + hitPose.position);
                }
                else
                {
                    placedObj.transform.position = hitPose.position;
